    ...
    <a href="inicio" class="logo">
      ...
      <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini">
            <img src="views/img/template/icono.png" class="img-responsive" style="padding:10px" alt="">
        </span>

      <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">
            <img src="views/img/template/logo.png" class="img-responsive" style="padding:10px" alt="">
        </span>
